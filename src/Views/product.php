...
<script>
    ...
    if (productContainer !== undefined) {
        const loadingEl = `<div class="w-full flex justify-center h-[15rem] align-middle" id="container-spinner"><div role="status" id="loading-el" class="m-auto">
    ...
    <span class="sr-only">Loading...</span>
        ...
        productContainer.innerHTML += loadingEl
    }
