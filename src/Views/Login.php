        ...
        <form action="/auth" method="POST" class="mb-0 mt-6 space-y-4">
            <div class="bg-blue-100 px-4 pt-4 pb-12 sm:px-6 sm:pt-6 sm:pb-14 lg:px-8 lg:pt-8 lg:pb-16 rounded-lg shadow-lg">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" class="w-full rounded-lg border-gray-200 p-2 pe-12 text-sm shadow-sm" placeholder="Enter email" name="username" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" class="w-full rounded-lg border-gray-200 p-2 pe-12 text-sm shadow-sm" placeholder="Enter password" name="password" />
                    </div>
                </div>
            </div>
