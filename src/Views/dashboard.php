...
<div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="w-full rounded-lg shadow p-4 md:p-6 bg-gray-800">
        <div class="flex justify-between">
            ...
            <div class="flex items-center px-2.5 py-0.5 text-2xl font-semibold text-yellow-500 text-center">
                <svg class="w-10 h-10 text-yellow" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
